...
# # Table of Contents
# * [1b. Fixed-flux spinodal decomposition on a square domain](#1a.-Fixed-flux-decomposition-on-a-square-domain)
...
import 
file_dir = "/data/and9/surf-research/Anushka/1bexample"


# In[10]:

import glob
newest = max(glob.iglob(file_dir + '/1b100*.npz'), key=os.path.getctime)
print newest
...
$ ffmpeg -f image2 -r 6 -i 'image%05d.png' 1b_test.mp4
# In[15]:
...
video = io.open('/tmp/testimages/1b_test.mp4', 'r+b').read()
